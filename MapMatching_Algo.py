...
noofpoints = 3  # gpspoints 101-148, 149-157, 158-163, 164-170, 171-174, 175-181 |---| gps2 points  
print 'Number of GPS points :', noofpoints
cur.execute("Select nid,lat,long,geom from gpspoints where pid > 103 order by pid limit %s;",(noofpoints,))
gpsPointsCol = cur.fetchall()
print 'GPS Points are --'
for i in gpsPointsCol:
    print i[1], ',', i[2]
